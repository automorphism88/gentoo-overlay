...
SRC_URI="https://cdn.kernel.org/pub/linux/kernel/v4.x/incr/patch-4.11.10-11.xz
	https://cdn.kernel.org/pub/linux/kernel/v4.x/incr/patch-4.11.9-10.xz"
SRC_URI+="
...
src_prepare() {
	for i in patch-4.11.9-10.xz patch-4.11.10-11.xz ; do
